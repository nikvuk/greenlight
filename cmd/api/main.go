...
import (
	...
	"github.com/nikvuk/greenlight/internal/mailer"
...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "d260e3a9e5485a", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "3b7d34391714f4", "SMTP password")
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "Greenlight <no-reply@greenlightvukovljak.org>", "SMTP sender")
